...
dl_api!(Ffi, DL,
	fn opus_strerror(::libc::c_int) -> *const ::libc::c_char,
	fn opus_get_version_string() -> *const ::libc::c_char,
	fn opus_encoder_create(::libc::c_int, ::libc::c_int,
		::libc::c_int, *mut ::libc::c_int) -> *mut OpusEncoder,
	fn opus_encode(*mut OpusEncoder, *const ::libc::c_short,
		::libc::c_int, *mut ::libc::c_uchar,
		::libc::c_int) -> ::libc::c_int,
	fn opus_encode_float(*mut OpusEncoder,
		*const ::libc::c_float, ::libc::c_int,
		*mut ::libc::c_uchar, ::libc::c_int) -> ::libc::c_int,
	fn opus_encoder_destroy(*mut OpusEncoder) -> (),
//	fn opus_encoder_ctl(*mut OpusEncoder, ::libc::c_int, ...)
//		-> ::libc::c_int,
	fn opus_decoder_create(::libc::c_int, ::libc::c_int,
		*mut ::libc::c_int) -> *mut OpusDecoder,
	fn opus_decode(*mut OpusDecoder, *const ::libc::c_uchar,
		::libc::c_int, *mut ::libc::c_short, ::libc::c_int,
		::libc::c_int) -> ::libc::c_int,
	fn opus_decode_float(*mut OpusDecoder, *const ::libc::c_uchar,
		::libc::c_int, *mut ::libc::c_float, ::libc::c_int,
		::libc::c_int) -> ::libc::c_int,
//	fn opus_decoder_ctl(*mut OpusDecoder, ::libc::c_int,
//		...) -> ::libc::c_int,
	fn opus_decoder_destroy(*mut OpusDecoder) -> (),
	fn opus_packet_parse(*const ::libc::c_uchar,
		::libc::c_int, *mut ::libc::c_uchar,
		*mut *const ::libc::c_uchar, *mut ::libc::c_short,
		*mut ::libc::c_int) -> ::libc::c_int,
	fn opus_packet_get_bandwidth(*const ::libc::c_uchar)
		-> ::libc::c_int,
	fn opus_packet_get_samples_per_frame(*const ::libc::c_uchar,
		::libc::c_int) -> ::libc::c_int,
	fn opus_packet_get_nb_channels(*const ::libc::c_uchar)
		-> ::libc::c_int,
	fn opus_packet_get_nb_frames(*const ::libc::c_uchar,
		::libc::c_int) -> ::libc::c_int,
	fn opus_packet_get_nb_samples(*const ::libc::c_uchar,
		::libc::c_int, ::libc::c_int) -> ::libc::c_int,
	fn opus_decoder_get_nb_samples(*const OpusDecoder,
		*const ::libc::c_uchar, ::libc::c_int) -> ::libc::c_int,
	fn opus_pcm_soft_clip(*mut ::libc::c_float,
		::libc::c_int, ::libc::c_int, *mut ::libc::c_float) -> (),
	fn opus_repacketizer_init(*mut OpusRepacketizer)
		-> *mut OpusRepacketizer,
	fn opus_repacketizer_create() -> *mut OpusRepacketizer,
	fn opus_repacketizer_destroy(*mut OpusRepacketizer) -> (),
	fn opus_repacketizer_cat(*mut OpusRepacketizer,
		*const ::libc::c_uchar, ::libc::c_int) -> ::libc::c_int,
	fn opus_repacketizer_out_range(*mut OpusRepacketizer, ::libc::c_int,
		::libc::c_int, *mut ::libc::c_uchar, ::libc::c_int)
			-> ::libc::c_int,
	fn opus_repacketizer_get_nb_frames(*mut OpusRepacketizer)
		-> ::libc::c_int,
	fn opus_repacketizer_out(*mut OpusRepacketizer, *mut ::libc::c_uchar,
		::libc::c_int) -> ::libc::c_int,
	fn opus_packet_pad(*mut ::libc::c_uchar, ::libc::c_int, ::libc::c_int)
		-> ::libc::c_int,
	fn opus_packet_unpad(*mut ::libc::c_uchar, ::libc::c_int)
		-> ::libc::c_int
);
